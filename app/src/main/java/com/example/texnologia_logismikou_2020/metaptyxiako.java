...
public class metaptyxiako extends AppCompatActivity {
    ...
    TabItem firstItem,secondItem
            ;
    PagerAdapter_Metaptyxiako adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_metaptyxiako);
        ...
        adapter = new PagerAdapter_Metaptyxiako(getSupportFragmentManager(), FragmentPagerAdapter.BEHAVIOR_RESUME_ONLY_CURRENT_FRAGMENT,mTabLayout.getTabCount());
        ...
        expandableListView.setOnGroupExpandListener(new ExpandableListView.OnGroupExpandListener() {
            ...
            public void onGroupExpand(int groupPosition) {
                Intent intent = new Intent(metaptyxiako.this, menu_redirection.class);
