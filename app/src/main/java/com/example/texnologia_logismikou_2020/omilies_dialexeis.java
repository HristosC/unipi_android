...
import com.example.texnologia_logismikou_2020.episitmonika_sunedria;
import java.util.ArrayList;
import java.util.HashMap;
import java.util.List;

public class omilies_dialexeis extends AppCompatActivity {
    ...
    public void createPosttxtView(@IdRes final int id, final String content, final int value, final String post){
        ...
        txt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(omilies_dialexeis.this, omilies_dialexeis_details.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_omilies_dialexeis);
        ...
        expandableListView.setOnGroupExpandListener(new ExpandableListView.OnGroupExpandListener() {
            ...
            public void onGroupExpand(int groupPosition) {
                Intent intent = new Intent(omilies_dialexeis.this, menu_redirection.class);
        ...
        String post = "Pavlou George: \"Information-Centric Networking: Overview, Current State and Key Challenges\"\n" +
                "\n" +
                ...
                "\n" +
                "Για να την παρακολουθήσετε από το blod του Ιδρύματος Μποδοσάκη, κάντε κλικ εδω: <a href=\"url\">http://www.blod.gr/lectures/Pages/viewlecture.aspx?LectureID=158</a>";
        createPosttxtView(R.id.omilia_dialexh_id_1, "<u> · Information-Centric Networking: Overview, Current State and Key Challenges </u>", 1,post);
        create_underline_info("12268","Κυριακή, 11 Ιουνίου 2017 21:29",500);
    }
    void create_underline_info(String read_times, String modify, int underline_top) {
        final RelativeLayout rl = (RelativeLayout) findViewById(R.id.layout_omilies);
