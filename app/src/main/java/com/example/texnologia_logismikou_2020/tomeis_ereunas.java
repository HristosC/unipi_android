    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        expandableListView.setOnGroupExpandListener(new ExpandableListView.OnGroupExpandListener() {
            ...
            public void onGroupExpand(int groupPosition) {
                Intent intent = new Intent(tomeis_ereunas.this, menu_redirection.class);
        ...
        create_underline_info("8078","Σάββατο, 27 Φεβρουαρίου 2016 01:11",2800);
    }
    void create_underline_info(String read_times, String modify, int underline_top) {
        final RelativeLayout rl = (RelativeLayout) findViewById(R.id.layout_tomeis_ereunas);
