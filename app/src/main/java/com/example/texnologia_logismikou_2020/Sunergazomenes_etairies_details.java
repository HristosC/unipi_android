...
public class Sunergazomenes_etairies_details extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sunergazomenes_etairies_details);
        ...
        expandableListView.setOnGroupExpandListener(new ExpandableListView.OnGroupExpandListener() {
            ...
            public void onGroupExpand(int groupPosition) {
                Intent intent = new Intent(Sunergazomenes_etairies_details.this, menu_redirection.class);
        ...
        if(id == 1){
            create_underline_info("29115","Δευτέρα, 29 Δεκεμβρίου 2014 02:31",900);
        }else{
            create_underline_info("7226","Δευτέρα, 29 Δεκεμβρίου 2014 02:26",1020);
        }

    }
    void create_underline_info(String read_times, String modify, int underline_top) {
        final RelativeLayout rl = (RelativeLayout) findViewById(R.id.layout_sunergazomense_etairies);
