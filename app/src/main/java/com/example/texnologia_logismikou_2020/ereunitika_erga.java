...
public class ereunitika_erga extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ereunitika_erga);

        TextView lst = (TextView) findViewById(R.id.lst_ereu_erga);
        String linkText ="FP7/ICT FET OPEN, 2009-2012 Scientific coordinator: Yannis Theodoridis <a href='http://www.modap.org'>http://www.modap.org</a>";
        lst.setText(Html.fromHtml(linkText));
        lst.setMovementMethod(LinkMovementMethod.getInstance());
        ...
        expandableListView.setOnGroupExpandListener(new ExpandableListView.OnGroupExpandListener() {
            ...
            public void onGroupExpand(int groupPosition) {
                Intent intent = new Intent(ereunitika_erga.this, menu_redirection.class);
        ...
        create_underline_info("6710","Πέμπτη, 25 Φεβρουαρίου 2016 17:48",4700);
    }
    void create_underline_info(String read_times, String modify, int underline_top) {
        final RelativeLayout rl = (RelativeLayout) findViewById(R.id.layout_ereunitika_erga);
